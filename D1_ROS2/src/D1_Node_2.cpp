...
D1_Node::D1_Node() : Node("D1_Node_2")
{
    ...
    topic_2d->initPublisher(this->create_publisher<sensor_msgs::msg::LaserScan>  ("scan_2",    10),
                            this->create_publisher<sensor_msgs::msg::PointCloud2>("scan_2D_2", 10));

    topic_3d->initPublisher(this->create_publisher<sensor_msgs::msg::Image>      ("scan_image_2", 10),
                            this->create_publisher<sensor_msgs::msg::PointCloud2>("scan_3D_2",    10));
