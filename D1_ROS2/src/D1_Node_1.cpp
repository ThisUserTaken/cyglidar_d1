...
D1_Node::D1_Node() : Node("D1_Node_1")
{
    ...
    topic_2d->initPublisher(this->create_publisher<sensor_msgs::msg::LaserScan>  ("scan_1",    10),
                            this->create_publisher<sensor_msgs::msg::PointCloud2>("scan_2D_1", 10));

    topic_3d->initPublisher(this->create_publisher<sensor_msgs::msg::Image>      ("scan_image_1", 10),
                            this->create_publisher<sensor_msgs::msg::PointCloud2>("scan_3D_1",    10));
